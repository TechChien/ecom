...
export const ReviewForm = () => {
  return (
    <div>
      <h1 className="text-slate-400 text-3xl font-bold mt-4">Write a review</h1>
      <form className="flex flex-col gap-3 mt-4">
        ...
        />
        <label className="font-bold text-2xl" htmlFor="summary">
          SUMMARY
        </label>
        <input
          id="summary"
        ...
        <div>
          <button
            type="submit"
            className="px-6 py-4 rounded-full text-xl text-white bg-red-500 hover:bg-red-400 mt-4"
          >
            Submit Review
          </button>
        </div>
